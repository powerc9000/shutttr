...
if($domain == "localhost:8888" | $domain == "dev:8888"){
	echo '<link rel="stylesheet" href="'. site_url("assets/css/stream.css?v=1"). '">';
}
else {
	echo '<link rel="stylesheet" href="'. site_url("assets/css/stream_prod.css?v=1"). '">';
      ...
      <div id="sub-menu">
          <nav>
            ...
            <li<?= $v_g ? ' class="not-viewed-gl"' : "" ?>>
               <?= $v_g ? '<a href="'.  site_url("guidelines"). '">Guidelines</a>' : "" ?>
            </li><?endif?>
